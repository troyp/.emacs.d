(custom-set-variables
 ...
 '(sml-program-name "/opt/smlnj/bin/sml")
 '(tool-bar-mode nil)
...
(setq my-themes '(adwaita zenburn misterioso))
(setq light-theme 'adwaita)
(setq dark-theme 'zenburn)
(load-theme dark-theme t) (setq current-theme dark-theme)
...
;; (define-key evil-visual-state-map (kbd "C-d") #'evil-normal-state)
;; (define-key evil-operator-state-map (kbd "C-d") #'evil-normal-state)
;; (define-key evil-motion-state-map (kbd "C-d") #'evil-normal-state)
;; ;;
